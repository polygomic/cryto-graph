...
import { BD_ZERO, BI_ONE, BI_ZERO, getCrytoPriceInUSD, TRACKED_PAIRS } from "./utils";
...
export function handleUserRegister(event: UserRegister): void {
  ...
  if (competition === null) {
    ...
    competition.volumeCRYTO = BD_ZERO;
